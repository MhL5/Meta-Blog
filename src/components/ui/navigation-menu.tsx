...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-9 w-max items-center justify-center rounded-md bg-background py-2 text-sm font-semibold transition-colors disabled:pointer-events-none disabled:opacity-50",
);
